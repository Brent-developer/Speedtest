...
if __name__ == "__main__":
    ...
    # Fixing the file path issue using a raw string and setting the image after the window is created
    img = PhotoImage(file=r'C:\Users\Brent\OneDrive\Pictures\duck.PNG')
